...
public class ProfileLengkapActivity extends BaseActivity
    ...
    private com.zam.sidik_sumenep.home.tambahpeternak.SpinnerAdapter adapterSpinnerProvinsi, adapterSpinnerKabupaten,
    ...
    private void showPageNotLoadedErrorDialog() {
        ...
        new AlertDialog.Builder(this).setMessage(com.zam.sidik_sumenep.R.string.please_reload_the_page).setPositiveButton(android.R.string.ok,
