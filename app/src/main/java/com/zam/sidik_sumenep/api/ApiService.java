package com.zam.sidik_sumenep.api;

import static com.zam.sidik_sumenep.util.Config.URL_BERITA;
import static com.zam.sidik_sumenep.util.Config.URL_HITUNG_TERNAK;
import static com.zam.sidik_sumenep.util.Config.URL_JUMLAH_TERNAK;
import static com.zam.sidik_sumenep.util.Config.URL_LIHAT_DATA_TERNAK;
import static com.zam.sidik_sumenep.util.Config.URL_LIHAT_DATA_TERNAK_SKLB;
import static com.zam.sidik_sumenep.util.Config.URL_NAMA_DAERAH;
import static com.zam.sidik_sumenep.util.Config.URL_PEMILIK;
import static com.zam.sidik_sumenep.util.Config.URL_PETUGAS;
import static com.zam.sidik_sumenep.util.Config.URL_PROFILE;
import static com.zam.sidik_sumenep.util.Config.URL_SERTIFIKAT_SKLB;
import static com.zam.sidik_sumenep.util.Config.URL_SETTING_SKLB;
...
import com.zam.sidik_sumenep.home.dataternak.vm.detail.DetailTernakResponse;
import com.zam.sidik_sumenep.home.dataternak.vm.foto.FotoTernakResponse;
import com.zam.sidik_sumenep.home.dataternak.vm.kondisi.KondisiResponse;
import com.zam.sidik_sumenep.home.dataternak.vm.list.DataTernakResponse;
import com.zam.sidik_sumenep.home.dataternak.vm.list.HitungTernak;
import com.zam.sidik_sumenep.home.memberhome.mvp.BeritaResponse;
import com.zam.sidik_sumenep.home.newsinfo.bukaberita.komentar.KomentarResponse;
import com.zam.sidik_sumenep.home.newsinfo.bukaberita.mvp.BukaBeritaResponse;
import com.zam.sidik_sumenep.home.newsinfo.mvp.navmenu.NavMenuResponse;
import com.zam.sidik_sumenep.home.sklb.dataternak.vm.DataTernakSklbResponse;
import com.zam.sidik_sumenep.home.sklb.petugas.vm.PetugasResponse;
import com.zam.sidik_sumenep.home.sklb.petugas.vm.desa.DesaResponse;
import com.zam.sidik_sumenep.home.sklb.petugas.vm.kab.KabResponse;
import com.zam.sidik_sumenep.home.sklb.petugas.vm.kec.KecResponse;
import com.zam.sidik_sumenep.home.sklb.petugas.vm.pemilik.PemilikResponse;
import com.zam.sidik_sumenep.home.sklb.print.sertifikat.vm.SertifikatResponse;
import com.zam.sidik_sumenep.home.sklb.setting.kuantitatif.SettingDinas;
import com.zam.sidik_sumenep.home.sklb.setting.skor.ListKuantitatif;
import com.zam.sidik_sumenep.profilku.model.ProfileResponse;
