package com.zam.sidik_sumenep.home.sklb.setting.kuantitatif;
...
import com.zam.sidik_sumenep.cutout.CutOut;
import com.zam.sidik_sumenep.cutout.CutOutActivity;
...
//import com.zam.sidik_sumenep.BuildConfig;
import com.zam.sidik_sumenep.databinding.ActivityTtdBinding;
import com.zam.sidik_sumenep.util.Util;
import io.paperdb.Paper;

import static com.zam.sidik_sumenep.cutout.CutOut.CUTOUT_ACTIVITY_REQUEST_CODE;
import static com.theartofdev.edmodo.cropper.CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE;
import static com.zam.sidik_sumenep.home.sklb.setting.kuantitatif.KuantitatifListFragment.CUTOUT_EXTRA_SOURCE;
    ...
    private Uri uriFromFile(File f) {
        try {
            ...
            return FileProvider.getUriForFile(this,
                    "com.zam.sidik_sumenep.provider",//BuildConfig.APPLICATION_ID + ".provider",
                    f);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
